...
#define WHEEL_DIAMETER 4 // Diameter of the wheel. Common values in appendix
#define ROBOT_DIAMETER 12 // Distance from the center of one wheel to the center of the other.
